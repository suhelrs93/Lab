 ...
 * Create two subclasses called "Circle" and "Rectangle" that inherit from Shape 
 * and implement the "calculateArea" method. Create objects of both the Circle and Rectangle classes 
